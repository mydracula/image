...
!(function (e, t) {
      ...
      if (/AppleWebKit\/(\S+)/.test(t)) {
        if (((this.engine.name = 'WebKit'), (this.engine.version = RegExp.$1), /OPR\/(\S+)/.test(t))) (this.browser.name = 'Opera'), (this.browser.version = RegExp.$1)
          ...
          if (((this.browser.name = 'Safari'), /Version\/(\S+)/.test(t))) this.browser.version = RegExp.$1
            ...
            ;(i = a < 100 ? 1 : a < 312 ? 1.2 : a < 412 ? 1.3 : 2), (this.browser.version = i)
          }
      } else
        e.opera
          ? ((this.engine.name = 'Presto'), (this.browser.name = 'Opera'), (this.engine.version = this.browser.version = e.opera.version()))
          : /Opera[\/\s](\S+)/.test(t)
          ? ((this.engine.name = 'Presto'), (this.browser.name = 'Opera'), (this.engine.version = browser.version = RegExp.$1))
          : /KHTML\/(\S+)/.test(t)
          ? ((this.browser.name = 'Konqueror'), (this.engine.name = 'KHTML'), (this.engine.version = browser.version = RegExp.$1))
          : /Konqueror\/([^;]+)/.test(t)
          ? ((this.browser.name = 'Konqueror'), (this.engine.name = 'Konqueror'), (this.engine.version = browser.version = RegExp.$1))
          : /rv:([^\)]+)\) Gecko\/\d{8}/.test(t)
          ? ((this.engine.name = 'Gecko'), (this.engine.version = RegExp.$1), /Firefox\/(\S+)/.test(t) && ((this.browser.name = 'Firefox'), (this.browser.version = RegExp.$1)))
          : /Trident\/([\d\.]+)/.test(t)
          ? ((this.engine.name = 'Trident'), (this.engine.version = RegExp.$1), (/rv\:([\d\.]+)/.test(t) || /MSIE ([^;]+)/.test(t)) && ((this.browser.name = 'IE'), (this.browser.version = RegExp.$1)))
          : /MSIE ([^;]+)/.test(t) && ((this.engine.name = 'Trident'), (this.engine.version = this.browser.version - 4), (this.browser.name = 'IE'), (this.browser.version = RegExp.$1))
    },
    judgeSystem: function () {
      ...
      ;(this.system.name = 0 == t.indexOf('Win') ? 'Windows' : this.system.name),
        ...
        'Windows' == this.system.name &&
          ...
          ('NT' == RegExp.$1
            ? (this.system.version = { '5.0': '2000', 5.1: 'XP', '6.0': 'Vista', 6.1: '7', 6.2: '8', 6.3: '8.1', '10.0': '10' }[RegExp.$2] || 'NT ' + RegExp.$2)
            : '9x' == RegExp.$1
  ...
  (function (e) {
    ...
    function o(e, i) {
      ...
      for (var h = 1732584193, p = -271733879, u = -1732584194, g = 271733878, m = 0; m < e.length; m += 16)
        (h = a((o = h), (l = p), (c = u), (d = g), e[m], 7, -680876936)),
          ...
          (h = n(h, (p = a(p, u, g, h, e[m + 15], 22, 1236535329)), u, g, e[m + 1], 5, -165796510)),
          ...
          (h = r(h, (p = n(p, u, g, h, e[m + 12], 20, -1926607734)), u, g, e[m + 5], 4, -378558)),
          ...
          (h = s(h, (p = r(p, u, g, h, e[m + 2], 23, -995338651)), u, g, e[m], 6, -198630844)),
    ...
    function l(e) {
      for (var t = '', i = 32 * e.length, a = 0; a < i; a += 8) t += String.fromCharCode((e[a >> 5] >>> a % 32) & 255)
      return t
    }
    function c(e) {
      var t = []
      for (t[(e.length >> 2) - 1] = void 0, a = 0; a < t.length; a += 1) t[a] = 0
      for (var i = 8 * e.length, a = 0; a < i; a += 8) t[a >> 5] |= (255 & e.charCodeAt(a / 8)) << a % 32
      return t
    }
    function d(e) {
      for (var t, i = '0123456789abcdef', a = '', n = 0; n < e.length; n += 1) (t = e.charCodeAt(n)), (a += i.charAt((t >>> 4) & 15) + i.charAt(15 & t))
      return a
    }
    function h(e) {
    ...
    function u(e, t) {
      return (function (e, t) {
        var i,
          ...
          r = [],
          s = []
        for (r[15] = s[15] = void 0, 16 < n.length && (n = o(n, 8 * e.length)), i = 0; i < 16; i += 1) (r[i] = 909522486 ^ n[i]), (s[i] = 1549556828 ^ n[i])
        return (a = o(r.concat(c(t)), 512 + 8 * t.length)), l(o(s.concat(a), 640))
      })(h(e), h(t))
    }
    function g(e, t, i) {
  ...
  function () {
    ...
    function t(e, t) {
      ...
      for (var r = 0; r < e.length; ++r) {
        ...
        if (!a.helper.isString(o.type)) return (n.valid = !1), (n.error = s + 'property "type" must be a string, but ' + typeof o.type + ' given'), n
        var l = (o.type = o.type.toLowerCase())
        if (('language' === l && (l = o.type = 'lang'), 'html' === l && (l = o.type = 'output'), 'lang' !== l && 'output' !== l && 'listener' !== l))
          return (n.valid = !1), (n.error = s + 'type ' + l + ' is not recognized. Valid values: "lang/language", "output/html" or "listener"'), n
        if ('listener' === l) {
          if (a.helper.isUndefined(o.listeners)) return (n.valid = !1), (n.error = s + '. Extensions of type "listener" must have a property called "listeners"'), n
        } else if (a.helper.isUndefined(o.filter) && a.helper.isUndefined(o.regex))
          return (n.valid = !1), (n.error = s + l + ' extensions must define either a "regex" property or a "filter" method'), n
        if (o.listeners) {
          if ('object' != typeof o.listeners) return (n.valid = !1), (n.error = s + '"listeners" property must be an object but ' + typeof o.listeners + ' given'), n
          for (var c in o.listeners)
            if (o.listeners.hasOwnProperty(c) && 'function' != typeof o.listeners[c])
              return (
                (n.valid = !1), (n.error = s + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + c + ' must be a function but ' + typeof o.listeners[c] + ' given'), n
              )
        }
        if (o.filter) {
          if ('function' != typeof o.filter) return (n.valid = !1), (n.error = s + '"filter" must be a function, but ' + typeof o.filter + ' given'), n
        } else if (o.regex) {
          if ((a.helper.isString(o.regex) && (o.regex = new RegExp(o.regex, 'g')), !(o.regex instanceof RegExp)))
            return (n.valid = !1), (n.error = s + '"regex" property must either be a string or a RegExp object, but ' + typeof o.regex + ' given'), n
          if (a.helper.isUndefined(o.replace)) return (n.valid = !1), (n.error = s + '"regex" extensions must implement a replace string or function'), n
        }
      }
      return n
    }
    ...
    ;(a.helper = {}),
      ...
      (a.helper.forEach = function (e, t) {
        ...
        else if (a.helper.isArray(e)) for (var i = 0; i < e.length; i++) t(e[i], i, e)
        else {
      ...
      do {
        for (n = 0; (s = h.exec(e)); )
          if (p.test(s[0])) n++ || (o = (r = h.lastIndex) - s[0].length)
            ...
            var g = { left: { start: o, end: r }, match: { start: r, end: s.index }, right: { start: s.index, end: l }, wholeMatch: { start: o, end: l } }
    ...
    ;(a.helper.matchRecursiveRegExp = function (e, t, i, a) {
      ...
      for (var n = c(e, t, i, a), r = [], s = 0; s < n.length; ++s)
        r.push([e.slice(n[s].wholeMatch.start, n[s].wholeMatch.end), e.slice(n[s].match.start, n[s].match.end), e.slice(n[s].left.start, n[s].left.end), e.slice(n[s].right.start, n[s].right.end)])
      return r
    }),
      (a.helper.replaceRecursiveRegExp = function (e, t, i, n, r) {
        ...
        if (d > 0) {
          var h = []
          0 !== o[0].wholeMatch.start && h.push(e.slice(0, o[0].wholeMatch.start))
          for (var p = 0; p < d; ++p)
            h.push(
              t(e.slice(o[p].wholeMatch.start, o[p].wholeMatch.end), e.slice(o[p].match.start, o[p].match.end), e.slice(o[p].left.start, o[p].left.end), e.slice(o[p].right.start, o[p].right.end))
            ),
              p < d - 1 && h.push(e.slice(o[p].wholeMatch.end, o[p + 1].wholeMatch.start))
          o[d - 1].wholeMatch.end < e.length && h.push(e.slice(o[d - 1].wholeMatch.end)), (l = h.join(''))
        }
        return l
      }),
      ...
      (a.Converter = function (e) {
        ...
        function i(e, i) {
          if (((i = i || null), a.helper.isString(e))) {
            ...
            if (a.helper.isUndefined(r[e])) throw Error('Extension "' + e + '" could not be loaded. It was either not found or is not a valid extension.')
            e = r[e]
          }
          ...
          for (var o = 0; o < e.length; ++o) {
            ...
            if (e[o].hasOwnProperty('listeners')) for (var l in e[o].listeners) e[o].listeners.hasOwnProperty(l) && n(l, e[o].listeners[l])
          }
        }
        function n(e, t) {
        ...
        var c = {},
          ...
          g = { parsed: {}, raw: '', format: '' }
        !(function () {
          for (var t in ((e = e || {}), s)) s.hasOwnProperty(t) && (c[t] = s[t])
          ...
          (this.makeHtml = function (e) {
            ...
            return (
              ...
              (e = '\n\n' + e + '\n\n'),
              (e = (e = a.subParser('detab')(e, c, t)).replace(/^[ \t]+$/gm, '')),
              ...
              (e = (e = (e = a.subParser('unescapeSpecialChars')(e, c, t)).replace(/¨D/g, '$$')).replace(/¨T/g, '¨')),
          ...
          (this.makeMarkdown = this.makeMd = function (e, t) {
              ...
              preList: (function (e) {
                for (var t = e.querySelectorAll('pre'), i = [], n = 0; n < t.length; ++n)
                  if (1 === t[n].childElementCount && 'code' === t[n].firstChild.tagName.toLowerCase()) {
                    ...
                    if ('' === s)
                      for (var o = t[n].firstChild.className.split(' '), l = 0; l < o.length; ++l) {
                    ...
                    ;(r = a.helper.unescapeHTMLEntities(r)), i.push(r), (t[n].outerHTML = '<precode language="' + s + '" precodenum="' + n.toString() + '"></precode>')
            ...
            for (var r = i.childNodes, s = '', o = 0; o < r.length; o++) s += a.subParser('makeMarkdown.node')(r[o], n)
            return s
          }),
          ...
          (this.removeExtension = function (e) {
            ...
            for (var t = 0; t < e.length; ++t) {
              for (var i = e[t], n = 0; n < d.length; ++n) d[n] === i && d[n].splice(n, 1)
      ...
      a.subParser('anchors', function (e, t, i) {
        ...
        var n = function (e, n, r, s, o, l, c) {
          if ((a.helper.isUndefined(c) && (c = ''), (r = r.toLowerCase()), e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)) s = ''
          else if (!s) {
            if ((r || (r = n.toLowerCase().replace(/ ?\n/g, ' ')), (s = '#' + r), a.helper.isUndefined(i.gUrls[r]))) return e
            ;(s = i.gUrls[r]), a.helper.isUndefined(i.gTitles[r]) || (c = i.gTitles[r])
          }
          var d = '<a href="' + (s = s.replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'
          return (
            '' !== c && null !== c && (d += ' title="' + (c = (c = c.replace(/"/g, '&quot;')).replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'),
            t.openLinksInNewWindow && !/^#/.test(s) && (d += ' rel="noopener noreferrer" target="¨E95Eblank"'),
            d + '>' + n + '</a>'
          )
        }
        return (
          (e = (e = (e = (e = (e = i.converter._dispatch('anchors.before', e, t, i)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, n)).replace(
            /\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g,
            n
          )).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, n)).replace(/\[([^\[\]]+)]()()()()()/g, n)),
          t.ghMentions &&
            (e = e.replace(/(^|\s)(\\)?(@([a-z\d]+(?:[a-z\d.-]+?[a-z\d]+)*))/gim, function (e, i, n, r, s) {
              if ('\\' === n) return i + r
              ...
              var o = t.ghMentionsLink.replace(/\{u}/g, s),
                l = ''
              return t.openLinksInNewWindow && (l = ' rel="noopener noreferrer" target="¨E95Eblank"'), i + '<a href="' + o + '"' + l + '>' + r + '</a>'
            })),
      ...
      f = function (e, t) {
        ...
        return function (i, n, r) {
          ...
          return (
            ...
            e.encodeEmails ? ((s = a.helper.encodeEmailAddress(s + r)), (r = a.helper.encodeEmailAddress(r))) : (s += r),
            n + '<a href="' + s + '">' + r + '</a>'
          )
        }
      }
    a.subParser('autoLinks', function (e, t, i) {
      'use strict'
      return (e = (e = (e = i.converter._dispatch('autoLinks.before', e, t, i)).replace(p, m(t))).replace(g, f(t, i))), i.converter._dispatch('autoLinks.after', e, t, i)
    }),
      a.subParser('simplifiedAutoLinks', function (e, t, i) {
        ...
        return t.simplifiedAutoLink
          ? ((e = i.converter._dispatch('simplifiedAutoLinks.before', e, t, i)),
            (e = (e = t.excludeTrailingPunctuationFromURLs ? e.replace(h, m(t)) : e.replace(d, m(t))).replace(u, f(t, i))),
      ...
      a.subParser('codeSpans', function (e, t, i) {
        'use strict'
        return (
          void 0 === (e = i.converter._dispatch('codeSpans.before', e, t, i)) && (e = ''),
          (e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (e, n, r, s) {
            var o = s
            return (o = (o = o.replace(/^([ \t]*)/g, '')).replace(/[ \t]*$/g, '')), (o = n + '<code>' + (o = a.subParser('encodeCode')(o, t, i)) + '</code>'), a.subParser('hashHTMLSpans')(o, t, i)
          })),
      ...
      a.subParser('completeHTMLDocument', function (e, t, i) {
        ...
        for (var c in (void 0 !== i.metadata.parsed.doctype &&
          ((n = '<!DOCTYPE ' + i.metadata.parsed.doctype + '>\n'), ('html' !== (a = i.metadata.parsed.doctype.toString().toLowerCase()) && 'html5' !== a) || (s = '<meta charset="utf-8">')),
        i.metadata.parsed))
          if (i.metadata.parsed.hasOwnProperty(c))
            switch (c.toLowerCase()) {
              ...
              case 'title':
                ...
                break
              case 'charset':
                s = 'html' === a || 'html5' === a ? '<meta charset="' + i.metadata.parsed.charset + '">\n' : '<meta name="charset" content="' + i.metadata.parsed.charset + '">\n'
                break
              case 'language':
              case 'lang':
                ;(o = ' lang="' + i.metadata.parsed[c] + '"'), (l += '<meta name="' + c + '" content="' + i.metadata.parsed[c] + '">\n')
                break
              default:
                l += '<meta name="' + c + '" content="' + i.metadata.parsed[c] + '">\n'
            }
        return (e = n + '<html' + o + '>\n<head>\n' + r + s + l + '</head>\n<body>\n' + e.trim() + '\n</body>\n</html>'), i.converter._dispatch('completeHTMLDocument.after', e, t, i)
      }),
      a.subParser('detab', function (e, t, i) {
        'use strict'
        return (
          (e = (e = (e = (e = (e = (e = i.converter._dispatch('detab.before', e, t, i)).replace(/\t(?=\t)/g, '    ')).replace(/\t/g, '¨A¨B')).replace(/¨B(.+?)¨A/g, function (e, t) {
            for (var i = t, a = 4 - (i.length % 4), n = 0; n < a; n++) i += ' '
            return i
      ...
      a.subParser('ellipsis', function (e, t, i) {
        'use strict'
        return (e = (e = i.converter._dispatch('ellipsis.before', e, t, i)).replace(/\.\.\./g, '…')), i.converter._dispatch('ellipsis.after', e, t, i)
      }),
      a.subParser('emoji', function (e, t, i) {
        'use strict'
        return t.emoji
          ? ((e = (e = i.converter._dispatch('emoji.before', e, t, i)).replace(/:([\S]+?):/g, function (e, t) {
      ...
      a.subParser('encodeAmpsAndAngles', function (e, t, i) {
        'use strict'
        return (
          (e = (e = (e = (e = (e = i.converter._dispatch('encodeAmpsAndAngles.before', e, t, i)).replace(/&(?!#?[xX]?(?:[0-9a-fA-F]+|\w+);)/g, '&amp;')).replace(/<(?![a-z\/?$!])/gi, '&lt;')).replace(
            /</g,
            '&lt;'
          )).replace(/>/g, '&gt;')),
      ...
      a.subParser('encodeBackslashEscapes', function (e, t, i) {
        'use strict'
        return (
          (e = (e = (e = i.converter._dispatch('encodeBackslashEscapes.before', e, t, i)).replace(/\\(\\)/g, a.helper.escapeCharactersCallback)).replace(
            /\\([`*_{}\[\]()>#+.!~=|-])/g,
      ...
      a.subParser('escapeSpecialCharsWithinTagAttributes', function (e, t, i) {
        'use strict'
        return (
          (e = (e = (e = i.converter._dispatch('escapeSpecialCharsWithinTagAttributes.before', e, t, i)).replace(/<\/?[a-z\d_:-]+(?:[\s]+[\s\S]+?)?>/gi, function (e) {
          ...
          i.converter._dispatch('escapeSpecialCharsWithinTagAttributes.after', e, t, i)
        )
      }),
      ...
      a.subParser('hashHTMLBlocks', function (e, t, i) {
        ...
        for (var s = 0; s < n.length; ++s)
          for (var o, l = new RegExp('^ {0,3}(<' + n[s] + '\\b[^>]*>)', 'im'), c = '<' + n[s] + '\\b[^>]*>', d = '</' + n[s] + '>'; -1 !== (o = a.helper.regexIndexOf(e, l)); ) {
        ...
        return (
          (e = e.replace(/(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g, a.subParser('hashElement')(e, t, i))),
      ...
      a.subParser('hashHTMLSpans', function (e, t, i) {
        ...
        return (
          (e = (e = (e = (e = (e = i.converter._dispatch('hashHTMLSpans.before', e, t, i)).replace(/<[^>]+?\/>/gi, function (e) {
            return a(e)
      ...
      a.subParser('headers', function (e, t, i) {
        ...
        function n(e) {
          ...
          return (
            (n = e),
            (r = a.helper.isString(t.prefixHeaderId) ? t.prefixHeaderId : !0 === t.prefixHeaderId ? 'section-' : ''),
            ...
            t.rawPrefixHeaderId && (n = r + n),
            i.hashLinkCounts[n] ? (n = n + '-' + i.hashLinkCounts[n]++) : (i.hashLinkCounts[n] = 1),
            n
          )
        }
      ...
      a.subParser('horizontalRule', function (e, t, i) {
        ...
        return (
          (e = (e = (e = e.replace(/^ {0,2}( ?-){3,}[ \t]*$/gm, n)).replace(/^ {0,2}( ?\*){3,}[ \t]*$/gm, n)).replace(/^ {0,2}( ?_){3,}[ \t]*$/gm, n)),
      ...
      a.subParser('images', function (e, t, i) {
        ...
        function n(e, t, n, r, s, o, l, c) {
          ...
          if (((n = n.toLowerCase()), c || (c = ''), e.search(/\(<?\s*>? ?(['"].*['"])?\)$/m) > -1)) r = ''
            ...
            if ((('' !== n && null !== n) || (n = t.toLowerCase().replace(/ ?\n/g, ' ')), (r = '#' + n), a.helper.isUndefined(d[n]))) return e
            ;(r = d[n]), a.helper.isUndefined(h[n]) || (c = h[n]), a.helper.isUndefined(p[n]) || ((s = p[n].width), (o = p[n].height))
          }
          t = t.replace(/"/g, '&quot;').replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)
          var u = '<img src="' + (r = r.replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '" alt="' + t + '"'
          return (
            c && a.helper.isString(c) && (u += ' title="' + (c = c.replace(/"/g, '&quot;').replace(a.helper.regexes.asteriskDashAndColon, a.helper.escapeCharactersCallback)) + '"'),
            s && o && ((u += ' width="' + (s = '*' === s ? 'auto' : s) + '"'), (u += ' height="' + (o = '*' === o ? 'auto' : o) + '"')),
            u + ' />'
          )
        }
        return (
          (e = (e = (e = (e = (e = (e = i.converter._dispatch('images.before', e, t, i)).replace(/!\[([^\]]*?)] ?(?:\n *)?\[([\s\S]*?)]()()()()()/g, n)).replace(
            /!\[([^\]]*?)][ \t]*()\([ \t]?<?(data:.+?\/.+?;base64,[A-Za-z0-9+/=\n]+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(["'])([^"]*?)\6)?[ \t]?\)/g,
            function (e, t, i, a, r, s, o, l) {
              return n(e, t, i, (a = a.replace(/\s/g, '')), r, s, 0, l)
            }
          )).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<([^>]*)>(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(?:(["'])([^"]*?)\6))?[ \t]?\)/g, n)).replace(
      ...
      a.subParser('italicsAndBold', function (e, t, i) {
        ...
        return (
          ...
          (e = t.literalMidWordAsterisks
            ? (e = (e = e.replace(/([^*]|^)\B\*\*\*(\S[\s\S]*?)\*\*\*\B(?!\*)/g, function (e, t, i) {
      ...
      a.subParser('lists', function (e, t, i) {
        ...
        function n(e, n) {
          ...
          var r = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0| {0,3}([*+-]|\d+[.])[ \t]+))/gm,
            s = /\n[ \t]*\n(?!¨0)/.test((e += '¨0'))
          return (
            t.disableForced4SpacesIndentedSublists && (r = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(¨0|\2([*+-]|\d+[.])[ \t]+))/gm),
            (e = (e = e.replace(r, function (e, n, r, o, l, c, d) {
              ...
              return (
                ...
                n || h.search(/\n{2,}/) > -1
                  ? ((h = a.subParser('githubCodeBlocks')(h, t, i)), (h = a.subParser('blockGamut')(h, t, i)))
                  : ((h = (h = a.subParser('lists')(h, t, i)).replace(/\n$/, '')),
                    (h = (h = a.subParser('hashHTMLBlocks')(h, t, i)).replace(/\n\n+/g, '\n\n')),
                    (h = s ? a.subParser('paragraphs')(h, t, i) : a.subParser('spanGamut')(h, t, i))),
        ...
        function s(e, i, a) {
          var s = t.disableForced4SpacesIndentedSublists ? /^ ?\d+\.[ \t]/gm : /^ {0,3}\d+\.[ \t]/gm,
            o = t.disableForced4SpacesIndentedSublists ? /^ ?[*+-][ \t]/gm : /^ {0,3}[*+-][ \t]/gm,
            l = 'ul' === i ? s : o,
            c = ''
          if (-1 !== e.search(l))
            !(function t(d) {
              var h = d.search(l),
                p = r(e, i)
              ;-1 !== h
                ? ((c += '\n\n<' + i + p + '>\n' + n(d.slice(0, h), !!a) + '</' + i + '>\n'), (l = 'ul' == (i = 'ul' === i ? 'ol' : 'ul') ? s : o), t(d.slice(h)))
                : (c += '\n\n<' + i + p + '>\n' + n(d, !!a) + '</' + i + '>\n')
            })(e)
          else {
            var d = r(e, i)
      ...
      a.subParser('metadata', function (e, t, i) {
        ...
        return t.metadata
          ? ((e = (e = (e = (e = i.converter._dispatch('metadata.before', e, t, i)).replace(/^\s*«««+(\S*?)\n([\s\S]+?)\n»»»+\n/, function (e, t, i) {
              return a(i), '¨M'
            })).replace(/^\s*---+(\S*?)\n([\s\S]+?)\n---+\n/, function (e, t, n) {
      ...
      a.subParser('outdent', function (e, t, i) {
        'use strict'
        return (e = (e = (e = i.converter._dispatch('outdent.before', e, t, i)).replace(/^(\t|[ ]{1,4})/gm, '¨0')).replace(/¨0/g, '')), i.converter._dispatch('outdent.after', e, t, i)
      }),
      a.subParser('paragraphs', function (e, t, i) {
        'use strict'
        for (var n = (e = (e = (e = i.converter._dispatch('paragraphs.before', e, t, i)).replace(/^\n+/g, '')).replace(/\n+$/g, '')).split(/\n{2,}/g), r = [], s = n.length, o = 0; o < s; o++) {
          var l = n[o]
          l.search(/¨(K|G)(\d+)\1/g) >= 0 ? r.push(l) : l.search(/\S/) >= 0 && ((l = (l = a.subParser('spanGamut')(l, t, i)).replace(/^([ \t]*)/g, '<p>')), (l += '</p>'), r.push(l))
        }
        for (s = r.length, o = 0; o < s; o++) {
          for (var c = '', d = r[o], h = !1; /¨(K|G)(\d+)\1/.test(d); ) {
            var p = RegExp.$1,
              u = RegExp.$2
            ;(c = (c = 'K' === p ? i.gHtmlBlocks[u] : h ? a.subParser('encodeCode')(i.ghCodeBlocks[u].text, t, i) : i.ghCodeBlocks[u].codeblock).replace(/\$/g, '$$$$')),
              (d = d.replace(/(\n\n)?¨(K|G)\d+\2(\n\n)?/, c)),
      ...
      a.subParser('strikethrough', function (e, t, i) {
        ...
        return (
          t.strikethrough &&
            ((e = (e = i.converter._dispatch('strikethrough.before', e, t, i)).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, function (e, n) {
              return (function (e) {
                return t.simplifiedAutoLink && (e = a.subParser('simplifiedAutoLinks')(e, t, i)), '<del>' + e + '</del>'
              })(n)
            })),
      ...
      a.subParser('stripLinkDefinitions', function (e, t, i) {
        ...
        var n = function (e, n, r, s, o, l, c) {
          return (
            (n = n.toLowerCase()),
            r.match(/^data:.+?\/.+?;base64,/) ? (i.gUrls[n] = r.replace(/\s/g, '')) : (i.gUrls[n] = a.subParser('encodeAmpsAndAngles')(r, t, i)),
            l ? l + c : (c && (i.gTitles[n] = c.replace(/"|'/g, '&quot;')), t.parseImgDimensions && s && o && (i.gDimensions[n] = { width: s, height: o }), '')
          )
        }
      ...
      a.subParser('tables', function (e, t, i) {
        ...
        function s(e, n) {
          return '<td' + n + '>' + a.subParser('spanGamut')(e, t, i) + '</td>\n'
        }
        function o(e) {
          var o,
            l = e.split('\n')
          for (o = 0; o < l.length; ++o)
            /^ {0,3}\|/.test(l[o]) && (l[o] = l[o].replace(/^ {0,3}\|/, '')), /\|[ \t]*$/.test(l[o]) && (l[o] = l[o].replace(/\|[ \t]*$/, '')), (l[o] = a.subParser('codeSpans')(l[o], t, i))
          ...
          for (o = 0; o < c.length; ++o) a.helper.isUndefined(u[o]) && (u[o] = ''), p.push(r(c[o], u[o]))
          for (o = 0; o < h.length; ++o) {
            for (var m = [], f = 0; f < p.length; ++f) a.helper.isUndefined(h[o][f]), m.push(s(h[o][f], u[f]))
            g.push(m)
          }
          return (function (e, t) {
            for (var i = '<table>\n<thead>\n<tr>\n', a = e.length, n = 0; n < a; ++n) i += e[n]
            for (i += '</tr>\n</thead>\n<tbody>\n', n = 0; n < t.length; ++n) {
              i += '<tr>\n'
        ...
        return t.tables
          ? ((e = (e = (e = (e = i.converter._dispatch('tables.before', e, t, i)).replace(/\\(\|)/g, a.helper.escapeCharactersCallback)).replace(
              /^ {0,3}\|?.+\|.+\n {0,3}\|?[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:[-=]){2,}[\s\S]+?(?:\n\n|¨0)/gm,
              o
            )).replace(/^ {0,3}\|.+\|[ \t]*\n {0,3}\|[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*\n( {0,3}\|.+\|[ \t]*\n)*(?:\n|¨0)/gm, o)),
      ...
      a.subParser('unescapeSpecialChars', function (e, t, i) {
        'use strict'
        return (
          (e = (e = i.converter._dispatch('unescapeSpecialChars.before', e, t, i)).replace(/¨E(\d+)E/g, function (e, t) {
            var i = parseInt(t)
      ...
      a.subParser('makeMarkdown.emphasis', function (e, t) {
        ...
        if (e.hasChildNodes()) {
          i += '*'
          for (var n = e.childNodes, r = n.length, s = 0; s < r; ++s) i += a.subParser('makeMarkdown.node')(n[s], t)
          i += '*'
        }
        return i
      }),
      a.subParser('makeMarkdown.header', function (e, t, i) {
        ...
        if (e.hasChildNodes()) {
          r = n + ' '
          for (var s = e.childNodes, o = s.length, l = 0; l < o; ++l) r += a.subParser('makeMarkdown.node')(s[l], t)
        }
        return r
      }),
      ...
      a.subParser('makeMarkdown.links', function (e, t) {
        ...
        if (e.hasChildNodes() && e.hasAttribute('href')) {
          var n = e.childNodes,
            r = n.length
          i = '['
          for (var s = 0; s < r; ++s) i += a.subParser('makeMarkdown.node')(n[s], t)
      ...
      a.subParser('makeMarkdown.list', function (e, t, i) {
        ...
        for (var r = e.childNodes, s = r.length, o = e.getAttribute('start') || 1, l = 0; l < s; ++l)
          void 0 !== r[l].tagName && 'li' === r[l].tagName.toLowerCase() && ((n += ('ol' === i ? o.toString() + '. ' : '- ') + a.subParser('makeMarkdown.listItem')(r[l], t)), ++o)
        return (n += '\n\x3c!-- --\x3e\n').trim()
      }),
      a.subParser('makeMarkdown.listItem', function (e, t) {
        'use strict'
        for (var i = '', n = e.childNodes, r = n.length, s = 0; s < r; ++s) i += a.subParser('makeMarkdown.node')(n[s], t)
        return (
          /\n$/.test(i)
            ? (i = i
                .split('\n')
      ...
      a.subParser('makeMarkdown.paragraph', function (e, t) {
        'use strict'
        var i = ''
        if (e.hasChildNodes()) for (var n = e.childNodes, r = n.length, s = 0; s < r; ++s) i += a.subParser('makeMarkdown.node')(n[s], t)
        return i.trim()
      }),
      ...
      a.subParser('makeMarkdown.table', function (e, t) {
        ...
        for (i = 0; i < o.length; ++i) {
          ...
          if (o[i].hasAttribute('style'))
            switch (o[i].getAttribute('style').toLowerCase().replace(/\s/g, '')) {
        ...
        for (i = 0; i < l.length; ++i) {
          ...
          for (n = 0; n < o.length; ++n) {
            var u = ' '
            void 0 !== p[n] && (u = a.subParser('makeMarkdown.tableCell')(p[n], t)), s[h].push(u)
          }
        }
        var g = 3
        ...
        for (i = 0; i < s.length; ++i) {
          for (n = 0; n < s[i].length; ++n)
            1 === i
              ? ':' === s[i][n].slice(-1)
                ? (s[i][n] = a.helper.padEnd(s[i][n].slice(-1), g - 1, '-') + ':')
      ...
      a.subParser('makeMarkdown.tableCell', function (e, t) {
        ...
        var i = ''
        if (!e.hasChildNodes()) return ''
        for (var n = e.childNodes, r = n.length, s = 0; s < r; ++s) i += a.subParser('makeMarkdown.node')(n[s], t, !0)
        return i.trim()
      }),
      a.subParser('makeMarkdown.txt', function (e) {
        ...
        return (
          ...
          (t = (t = (t = (t = (t = (t = (t = (t = a.helper.unescapeHTMLEntities(t)).replace(/([*_~|`])/g, '\\$1')).replace(/^(\s*)>/g, '\\$1>')).replace(/^#/gm, '\\#')).replace(
            /^(\s*)([-=]{3,})(\s*)$/,
            '$1\\$2$3'
...
function insertEmoji(e) {
  let t = document.getElementById('neirong'),
    i = t.value.length
  t.focus(), void 0 !== document.selection ? (document.selection.createRange().text = e) : (t.value = t.value.substr(0, t.selectionStart) + e + t.value.substring(t.selectionStart, i)), preview()
}
function preview() {
...
;(atEvery.prototype.init = function (e) {
  ...
  if (((t.config = e), console.log(window.AV), window.AV)) return e && t._init(), t
  {
    ...
    i.setAttribute('type', 'text/javascript'),
      (i.src = 'https://cdn.jsdelivr.net/npm/leancloud-storage@4.10.0/dist/av-min.js'),
  ...
  (atEvery.prototype._init = function () {
    let e = this,
      { appId: t, appKey: i, lang: a, pageSize: n, atEmoji: r, bgImg: s, motion: o, cssUrl: l, shuoPla: c, avatarPla: d, serverURL: h, color1: p, color2: u, color3: g } = e.config
    switch (((a = void 0 === a || '' === a ? 'zh' : a), (s = void 0 === s || '' === s ? 'https://cdn.jsdelivr.net/gh/drew233/cdn/20200409110727.webp' : s), a)) {
      case 'zh':
        var m = '加载更多...',
          f = '预览',
          _ = '发布',
          ...
          P = '密码不能为空',
          L = '用户名与密码不匹配',
          I = '登陆失败，常见错误有<br><li>网络错误</li><li>域名不在leancloud的域名白名单中被限制登录</li><li>当前页面使用了其他leancloud应用导致登录到了其他应用所以失败</li>',
          H = '未找到此用户',
          T = '尝试错误密码次数过多，请稍后再试'
        break
      case 'en':
        ;(m = 'load more...'),
          ...
          (I = 'Request has been terminated Possible causes: the network is offline, Origin is not allowed by Access-Control-Allow-Origin, the page is being unloaded, etc.c'),
          (H = 'Could not find user.'),
          (T = 'You have entered incorrect passwords for too many times. Please try later or reset your password.')
        break
      case 'es':
        ;(m = 'Carga más...'),
          (f = 'Avance'),
          ...
          (I = 'La solicitud ha sido cancelada Posibles causas: la red está fuera de línea, Access-Control-Allow-Origin no permite Origin, la página se está descargando, etc.c'),
          (H = 'No se pudo encontrar el usuario.'),
          (T = 'Ha introducido contraseñas incorrectas demasiadas veces. Inténtelo más tarde o restablezca su contraseña.')
    }
    let O = ''
    for (let e in r) O = O + "<img alt='[" + e + "]' title='" + e + "' onclick='insertEmoji(\"[" + e + "]\")' class='atemoji gallery-group-img' src='" + r[e] + "'/>"
    ;(c = void 0 === c ? '' : c),
      (d = void 0 === d ? '' : d),
      ...
      (n = void 0 === n ? '5' : n)
    try {
      '' !== h ? AV.init({ appId: t, appKey: i, serverURL: h }) : AV.init({ appId: t, appKey: i })
    } catch (e) {
      let t = e.toString()
    ...
    function V(e) {
      if (void 0 !== e) {
        for (let t in atEmojiQQ) {
          let i = '[' + t + ']',
            a = "<img class='atemoji gallery-group-img' src='" + atEmojiQQ[t] + "'/>"
          for (; -1 != e.indexOf(i); ) e = e.replace(i, a)
        }
        for (let t in atEmojiTB) {
          let i = '[' + t + ']',
            a = "<img class='atemoji gallery-group-img' src='" + atEmojiTB[t] + "'/>"
          for (; -1 != e.indexOf(i); ) e = e.replace(i, a)
        }
        for (let t in atEmojiBB) {
          let i = '[' + t + ']',
            a = "<img class='atemoji gallery-group-img' src='" + atEmojiBB[t] + "'/>"
          for (; -1 != e.indexOf(i); ) e = e.replace(i, a)
        }
        for (let t in r) {
          let i = '[' + t + ']',
    ...
    if (!document.getElementById('add-Artitalk_Style'))
      if ('' === l || void 0 === l) {
        ...
        ;(e.type = 'text/css'), (e.innerHTML = D), (e.id = 'add-Artitalk-Style'), document.head.appendChild(e)
      } else {
        let e = document.createElement('link')
        ;(e.rel = 'stylesheet'), (e.href = l), (e.id = 'add-Artitalk-Style'), document.head.appendChild(e)
      }
    var Q =
    ...
    ;(K.onclick = function () {
      ...
      (Z.onclick = function () {
        AV.User.current()
          ? '' === document.getElementById('shuoshuo_input').style.display
            ? R('shuoshuo_input')
            : $('shuoshuo_input')
          : ((document.getElementById('logw').innerHTML = '<center><pre><code>' + z + '</code></pre></center>'), U())
      }),
      (X.onclick = function () {
        document.getElementById('logw').innerHTML = ''
        let e = AV.User.current()
        $('shade'), e ? ($('userinfo'), (document.getElementById('status').innerHTML = k + ':\t' + e.attributes.username), $('tui')) : ($('tui'), $('shuoshuo-modal'), U())
      }),
      (Y.onclick = function () {
        N()
      }),
      (J.onclick = function () {
        ...
        if (((document.getElementById('logw').style.color = 'black'), (document.getElementById('logw').innerHTML = 'loading...'), '' === t))
          return (document.getElementById('logw').style.color = 'red'), void (document.getElementById('logw').innerHTML = P)
        let i = document.getElementById('username').value
        if ('' === i) return (document.getElementById('logw').style.color = 'red'), void (document.getElementById('logw').innerHTML = S)
        AV.User.logIn(i, t).then(
          (t) => {
            ;(document.getElementById('ccontent').innerHTML = ''), (document.getElementById('neirong').value = ''), $('lazy'), e.seeContent(0, e.config), N()
          },
          (e) => {
            let t = e.message
            ;(document.getElementById('logw').style.color = 'red'),
              -1 != t.indexOf('mismatch')
                ...
                ? (t = H)
                : -1 != t.indexOf('Please try later or reset your password.') && (t = T),
      ...
      (te.onclick = function () {
        document.getElementById('switch_1').classList.add('zuiliangdezai'),
          ...
          'none' === document.getElementById('shuoshuo_emojiswitch').style.display
      ...
      (le.onclick = function () {
        ...
        let s = r.makeHtml(i),
          o = void 0 === t.attributes.img ? 'https://cdn.jsdelivr.net/gh/drew233/cdn/logol.png' : t.attributes.img,
        ...
        a.set('atContentHtml', s),
          ...
          a.save().then(function (t) {
            ;(document.getElementById('ccontent').innerHTML = ''), (document.getElementById('neirong').value = ''), R('preview'), e.seeContent(0, e.config), R('shuoshuo_input')
          })
      }),
      (oe.onclick = function () {
      ...
      (ce.onclick = function () {
        R('shanchu'), R('shade'), $('lazy'), (document.getElementById('ccontent').innerHTML = ''), e.seeContent(0, e.config)
      }),
      (de.onclick = function () {
        if (!AV.User.current()) return (document.getElementById('logw').innerHTML = '<center><pre><code>' + z + '</code></pre></center>'), $('shade'), void $('shuoshuo-modal')
      ...
      (atEvery.prototype.delete = function (e) {
        ...
        i('shade'),
          ...
          (document.getElementById('delete1').innerHTML =
            '<input type="button" class="at_button" value="' + v + '" id="Delete"><input type="button" class="at_button" value="' + x + '" id="cancelDelete">')
      ...
      xhr.addEventListener('readystatechange', function () {
        if (4 === this.readyState && 200 === this.status) {
          ...
          'video' === fileType
            ...
            : 'image' === fileType && (sourceMd = '![](' + sourceUrl.data.url + ')'),
  ...
  (atEvery.prototype.seeContent = function (e, t) {
    let i = '',
      { lang: a, pageSize: n, motion: r, atEmoji: s, color1: o, color2: l, color3: c, atComment: d } = this.config
    ...
    k.descending('createdAt'),
      ...
      k.find().then(function (t) {
        ;(i = ''),
          t.forEach(function (e) {
            ...
            n = void 0 === n ? 'https://cdn.jsdelivr.net/gh/drew233/cdn/logol.png' : n
        ...
        ;(a = '' === a ? '<ul class="cbp_tmtimeline" id="maina">' : a),
          ...
          0 !== v ? _('readmore') : 0 !== e && ((document.getElementById('readButton').innerHTML = '<center>已经到底了哦~</center>'), (document.getElementById('readButton').style.opacity = '0.5'))
      }),
          ...
          i.find().then((i) => {
            i.forEach(function (i) {
              ...
              ;(n.id = 'atEditsaveButton'),
                ...
                t('readmore'),
                n.setAttribute('onclick', 'atEvery.prototype.atEditsave("' + e + '")'),
                pubShuo.click(),
                (document.getElementById('neirong').value = i.attributes.atContentMd),
                t('lazy')
            })
          })
      }),
        ...
        if (
          ...
          (t = (function (e) {
            if (void 0 !== e) {
              ...
              for (let t in s) {
                let i = '[' + t + ']',
                  a = "<img class='atemoji gallery-group-img' src='" + s[t] + "'/>"
                for (; -1 != e.indexOf(i); ) e = e.replace(i, a)
              }
              return e
            }
      ...
      (atEvery.prototype.saveComment = function (e, t) {
        ...
        let o = r.makeHtml(a),
          ...
          p = md5(d)
        if (!l && ('' === h || '' === d)) return (document.getElementById('neirong').value = '昵称，邮箱均为必填项\n' + document.getElementById('neirong').value), void i('lazy')
        let u = 'https://cdn.staticdn.net/avatar/' + p + '?d=mp&s=80',
          g = new Date()
        function m(e) {
          return e < 10 ? '0' + e : e
        }
        let f = g.getFullYear() + '-' + m(g.getMonth() + 1) + '-' + m(g.getDate()),
          _ = m(g.getHours()) + ':' + m(g.getMinutes()) + ':' + m(g.getSeconds()),
          k = g.getHours(),
          v = ''
        switch (v) {
          case k >= 0 && k < 5:
        ...
        if (l) {
          let e = void 0 === l.attributes.img ? 'https://cdn.jsdelivr.net/gh/drew233/cdn/logol.png' : l.attributes.img
      ...
      (atEvery.prototype.commentInit = function (e, t) {
        ...
        let n = 'atCoInit' + e
        a('coValue' + e),
          document.getElementById(n).setAttribute('onclick', 'location.reload()'),
          i('commentNick'),
          a('atSave'),
          i('commentSave'),
          i('lazy'),
          ...
          (document.getElementById('pubComment').onclick = function () {
            '' === document.getElementById('shuoshuo_input').style.display ? a('shuoshuo_input') : i('shuoshuo_input')
          }),
          ...
          d
            ...
            .then((e) => {
              e.forEach(function (e) {
                ...
                let a = new Date(t),
                  n = a.getFullYear() + '-' + i(a.getMonth() + 1) + '-' + i(a.getDate()),
                  r = i(a.getHours()) + ':' + i(a.getMinutes()) + ':' + i(a.getSeconds()),
                  s = a.getHours(),
                  l = ''
                switch (l) {
                  case s >= 0 && s < 5:
              ...
              ;(t = t.replace(/(.*)<\/ul>/, '$1 ')), (t += o + '</ul>'), (document.getElementById('ccontent').innerHTML = t)
            })
            .then(function () {
              i('email'), l && (a('commentNick'), a('email')), i('email'), a('lazy')
            }),
