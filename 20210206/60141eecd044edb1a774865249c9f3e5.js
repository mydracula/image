            ...
            ! function (e) {
                ...
                t && !t.classList.contains("loaded") && fetch('https://waline1.now.sh/comment?type=recent&count=')
                    ...
                    .then(data => {
                        ...
                        let i = arr.length
                        if (i) {
                            for (let r = "", o = 0; o < i; o++) r += '<li class="item"><a href="' + n[o].get("url") + "#" + n[o].id + '"><span class="breadcrumb">' + n[o].get("nick") + " @ " + (0, a.default)(n[o].get("createdAt"), e.i18n) + "</span><span>" + n[o].get("comment").replace(/<[^>]+>/gi, "").substr(0, 100) + "</span></a></li>";
                            console.log(r, o, i, '>>>>' + t);
...
//                     t.innerHTML += `<li class="item"><a href=${val.url}><span class="breadcrumb">${val.nick + str + gap}</span><span>${comment}</span></a></li>`;
//                     console.log(t);
//                     t.classList.add("loaded"), e.config.pjax && e.config.pjax.refresh(t)
//                 });
//             })
//             .catch(console.error)
//     }(e)
