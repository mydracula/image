! function (e, t) {
    ...
    return function (e) {
        ...
        e.exports = function (e) {
            ...
            var n = t(e.data),
                o = null;
            (o = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")).onreadystatechange = function () {
                if (4 === o.readyState) {
                    var t = o.status,
                        n = o.responseText,
                        r = o.responseXML;
                    try {
                        n = JSON.parse(n), r = JSON.parse(r)
                    } catch (a) {
                        n && (console.error(n), console.error(a))
                    }
                    if (t >= 200 && t < 300) {
                        if (e.success) try {
                            e.success(n, r)
            ...
            }, "GET" == e.type ? (o.open("GET", e.url + "?" + n, !0), o.send(null)) : "POST" == e.type && (o.open("POST", e.url, !0), o.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), o.send(n))
        }
    }, function (e, t, n) {
        "use strict";
        var i;
